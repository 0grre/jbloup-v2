...
<footer class="footer items-center p-4 bg-transparent">
    <div class="items-center grid-flow-col">
        <p>{ footer.footer + ' '}<a class="link link-hover" href={footer.github} target="_blank"
                                    rel="noreferrer">0grre</a> | last update: 24/10/2022</p>
    </div>
    <div class="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        ...
        <div class="tooltip" data-tip="We love dev">
            <a href={footer.welovedev} target="_blank" rel="noreferrer">
                <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                     viewBox="0 0 576 512">
